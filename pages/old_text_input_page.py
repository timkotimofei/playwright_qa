...
class TextInputPage:
    ...
    def click_email_filed_tab(self):
        # этот метод должен вернуть новую страницу - те новый page
        # так как это по сути ссылка на отдельную страницу
        pass

    def click_password_filed_tab(self):
        # этот метод должен вернуть новую страницу - те новый page
        # так как это по сути ссылка на отдельную страницу
        pass
